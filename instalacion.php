    ...
    <div class="col-9">
      ...
      para poder brindarle a su familiar todas las comodidades necesarias durante su estadia con nosotros, asì como para usted cuando asista al dìa de visita. </p>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="imagenes/canva/inst1.png" class="img-fluid" alt="..." width="1800">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="imagenes/canva/inst2.png" class="img-fluid" alt="..." width="1800">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="imagenes/canva/inst3.png" class="img-fluid" alt="..." width="1800">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
                <img src="imagenes/canva/inst4.png" class="img-fluid" alt="..." width="1800">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="imagenes/canva/inst5.png" class="img-fluid" alt="..." width="1800">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
                <img src="imagenes/canva/inst6.png" class="img-fluid" alt="..." width="1800">
            </div>
        </div>
    </div>
    </div>

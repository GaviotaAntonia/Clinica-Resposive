...
<html lang="es">
<head>
  <title>Administrador traslados</title>
  <meta charset="utf-8">
...
<body>
<br>
<h4 style="text-align: center;">Traslados asignados</h4> 
            ...
            while($mostrar=mysqli_fetch_array($result)){
              ...
              <tr>
               <td><?php echo $mostrar['nombre'] ?></td>
                ...
                <td><?php echo $mostrar['trasladotipo'] ?></td>
                <td><?php echo $mostrar['numerotelefono'] ?></td>
